  ...
  if (overrides) {
    ...
    if (unsupportedKeys.length) {
      ...
      if (isOverridingSetupFile) {
        ...
        console.error(
          chalk.red(
            '\nOut of the box, Do React App A Create only supports overriding ' +
              'these Jest options:\n\n' +
              supportedKeys
              ...
              'are not currently supported by Do React App A Create:\n\n' +
              unsupportedKeys
                .map(key => chalk.bold('  \u2022 ' + key))
                .join('\n') +
              ...
              'You may also file an issue with Do React App A Create to discuss ' +
