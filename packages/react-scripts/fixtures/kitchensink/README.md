# Contributing to Do React App A Create's E2E tests
...
These tests are run by **jest** and the environment is `test`, so that it resembles how a **Do React App A Create** application is tested.
