...
./node_modules/.bin/eslint --max-warnings 0 packages/do-react-app-a-create/
...
# ******************************************************************************
# First, test the do-react-app-a-create development environment.
...
# ******************************************************************************
# Install react-scripts prerelease via do-react-app-a-create prerelease.
# ******************************************************************************

# Install the app in a temporary location
cd $temp_app_path
npx do-react-app-a-create test-app
